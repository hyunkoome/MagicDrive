...
# 중복 등록 방지 코드 추가
#if 'SparseConv2d' not in CONV_LAYERS._module_dict:

# 기존 등록된 SparseConv2d 제거
if 'SparseConv2d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseConv2d...")  # 디버깅용
...
#if 'SparseConv3d' not in CONV_LAYERS._module_dict:

if 'SparseConv3d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseConv3d...")  # 디버깅용
...
# if 'SparseConv4d' not in CONV_LAYERS._module_dict:
if 'SparseConv4d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseConv4d...")  # 디버깅용
...
if 'SparseConvTranspose2d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseConvTranspose2d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SparseConvTranspose2d']
# if 'SparseConvTranspose2d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SparseConvTranspose3d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseConvTranspose3d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SparseConvTranspose3d']
# if 'SparseConvTranspose3d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SparseInverseConv2d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseInverseConv2d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SparseInverseConv2d']
# if 'SparseInverseConv2d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SparseInverseConv3d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SparseInverseConv3d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SparseInverseConv3d']
# if 'SparseInverseConv3d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SubMConv2d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SubMConv2d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SubMConv2d']
# if 'SubMConv2d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SubMConv3d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SubMConv3d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SubMConv3d']
# if 'SubMConv3d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
...
if 'SubMConv4d' in CONV_LAYERS._module_dict:
    print("Removing existing registration for SubMConv4d...")  # 디버깅용
    del CONV_LAYERS._module_dict['SubMConv4d']
# if 'SubMConv4d' not in CONV_LAYERS._module_dict:
@CONV_LAYERS.register_module()
